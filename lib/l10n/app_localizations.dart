...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'High School Career & Major Counseling'**
  String get appSubtitle;

  /// No description provided for @welcomeTitle.
  ///
  /// In en, this message translates to:
  /// **'Welcome to EduPath Career Assistant! 👋'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Ask about majors, universities, or careers...'**
  ...
  /// No description provided for @suggestedTopicsTitle.
  ///
  /// In en, this message translates to:
  /// **'Popular Guidance Topics:'**
  String get suggestedTopicsTitle;

  /// No description provided for @topicStem.
  ///
  /// In en, this message translates to:
  /// **'🔬 STEM & Tech Majors'**
  String get topicStem;

  /// No description provided for @topicArts.
  ///
  /// In en, this message translates to:
  /// **'🎨 Design & Media Careers'**
  String get topicArts;

  /// No description provided for @topicBusiness.
  ///
  /// In en, this message translates to:
  /// **'💼 Business & Marketing'**
  String get topicBusiness;

  /// No description provided for @topicHolland.
  ///
  /// In en, this message translates to:
  /// **'🧩 Holland RIASEC Personality Test'**
  String get topicHolland;

  /// No description provided for @topicSubjectCombo.
  ///
  /// In en, this message translates to:
  /// **'📚 High School Subject Selection'**
  String get topicSubjectCombo;
  ...
  /// No description provided for @counselorName.
  ///
  /// In en, this message translates to:
  /// **'EduPath Guidance AI'**
